...
namespace CarServiceSystem.Controllers
{
    public class RepairsController : Controller
    {
        ...
        {
            var appDbContext = _context.Repairs.Include(r => r.Car);
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,RepairDate,Cost,CarId")] Repair repair)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,RepairDate,Cost,CarId")] Repair repair)
        {
            if (id != repair.Id)
            {
                return NotFound();
